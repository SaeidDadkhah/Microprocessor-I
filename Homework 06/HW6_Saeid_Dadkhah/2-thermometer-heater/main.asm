;
; 2-thermometer-heater.asm
;
; Created: 12/9/2016 10:24:51 PM
...
RST_ISR:
	...
	; mode 0: TIN: ADC0: mux4..0: 00000
	; mode 1: MIN: ADC1: mux4..0: 00001
	; mode 2: MAX: ADC2: mux4..0: 00010 (Default)
	ldi r16, 0
	out SFIOR, r16
	ldi r16, (0 << REFS1) | (1 << REFS0) | (0 << ADLAR) | (0 << MUX4) | (0 << MUX3) | (0 << MUX2) | (1 << MUX1) | (0 << MUX0)
	out ADMUX, r16
